...
> Versão da API: **1.1.18** | Idioma da API e mensagens: **português (BR)**
...
*Última revisão: agosto/2026 — alinhado com v1.1.18 (soft-delete/LGPD, drop do próprio jogador, bloqueio de torneios)*
