...
> Versão da API: **1.1.23** | Idioma da API e mensagens: **português (BR)**
...
*Última revisão: agosto/2026 — alinhado com v1.1.23 (undrop de jogadores e configuração de texto do Story Top 8)*
